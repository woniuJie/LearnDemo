...
import com.zsj.learndemo.MyApplication;
...
public class ScreenUtils {
    ...
    public static float pxToSp(float pxValue) {
        return pxValue /  MyApplication.getInstance().getResources().getDisplayMetrics().scaledDensity;
    }
    ...
    public static float spToPx(float spValue) {
        return spValue *  MyApplication.getInstance().getResources().getDisplayMetrics().scaledDensity;
    }
    ...
    public static int getScreenBrightnessInt255() {
        ...
        try {
            screenBrightness = Settings.System.getInt(MyApplication.getInstance().getContentResolver(), Settings.System.SCREEN_BRIGHTNESS);
        } catch (Exception e) {
            e.printStackTrace();
        }
