...
/**
 * Created by zhangshijie on 2019/6/3;
 */
public class NotificationUtils extends ContextWrapper {
    ...
    private NotificationCompat.Builder getNotification(String title, String content, String imageUrl, PendingIntent pendingIntent) {
     ...
     * 发送通知
     */
    public void sendNotification(int notifyId, String title, String content, String imageUrl, PendingIntent intent) {
        NotificationCompat.Builder builder = getNotification(title, content, imageUrl, intent);
